module.exports = {
  ...
  "info": {
    ...
    "description": "Petstore API where all operations declare a valid operationId.",
    "contact": {
      "name": "API Support",
  ...
  "channels": {
    "pet/created": {
      "description": "Subscribe-only channel with a valid operationId.",
      "subscribe": {
    ...
    "pet/updated": {
      "description": "Publish-only channel with a valid operationId.",
      "publish": {
    ...
    "order/placed": {
      "description": "Dual-operation channel where both operations have unique operationIds.",
      "subscribe": {
    ...
    "inventory/low": {
      "description": "Subscribe channel with a camelCase operationId.",
      "subscribe": {
    ...
    "store/notification": {
      "description": "Dual-operation channel where subscribe and publish have distinct operationIds.",
      "subscribe": {
